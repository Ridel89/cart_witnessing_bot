...
Документ можна створити в google таблицях або на google диску. Також потрібно відкрити доступ до цього документу по посиланню. Для цього клікаємо на кнопку `Поділитися`, або правою кнопкою миші на створеному документі `Надати доступ` -> `Поділитися`. В діалоговому вікні яке з'явиться - `Загальний доступ` : `Усі, хто має посилання`  -> `Може переглядати`. 
